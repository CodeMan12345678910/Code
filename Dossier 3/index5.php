...
<body>
        ...
        <div class="container mt-5">
            ...
            <?php foreach ($candidat_votes as $nom => $data): ?>
                <div class="candidate-card"
                    style="margin: 15px; border: 1px solid #ddd; padding: 15px; border-left-color:5px #fb7e11;">
    ...
    <center>
        <p class="text-center" style="font-size: 30px;">Nombre de votant :
            <strong><?php echo count($single_vote_users); ?></strong> / <strong><?php echo $total_votes; ?></strong>
            étudiants </p>
    </center>
    ...
    <center>
        ...
        <h3 id="gsap-text" class="animated-text1 mt-5"> <span style="color : #fb7e11;">ESMA,</span> L'école qui
            professionnalise votre talent</h3>
